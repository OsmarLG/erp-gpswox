...
class Index extends Component
{
    ...
    public array $headers = [
        ...
        ['key' => 'obsercaciones', 'label' => 'Obsercaciones', 'class' => 'text-black dark:text-white'],
    ];
    ...
    public function createServicio()
    {
        ...
        if (!$this->continuarCreando) {
            ...
            $this->reset(['serviceNombre', 'servicePeriodicidadKm', 'servicePeriodicidadDias', 'serviceObservaciones']);
        }
    ...
    public function editServicio(int $serviceId)
    {
        ...
        $this->servicePeriodicidadKm  = $service->periodicidad_km;
        $this->servicePeriodicidadDias = $service->periodicidad_dias;
